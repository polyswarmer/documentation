...
<div class="m-flag">
  <p><strong>Note:</strong> the PolySwarm marketplace will be a source of previously unseen malware.</p>
  ...
  <p>This guide should not be taken as a recommendation for how to approach the marketplace but rather an example of how to incorporate an existing analysis backend into a <strong>Microengine</strong> skeleton.</p>
</div>
